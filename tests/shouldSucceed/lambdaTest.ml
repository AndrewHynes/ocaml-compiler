...
let tests = [
    ...
    ("(Assignment: x = (Plus 300, 500))(Lambda (VARIABLES: identifier : x), (Plus 3, 3))", stringToAST "let x = 300 + 500; (λ x → 3 + 3)");
    ("(Assignment: x = 800.)(Lambda (VARIABLES: identifier : x), 6.)", stringToOptimisedAST "let x = 300 + 500; (λ x → 3 + 3)");
